...
database = cosmos_client.get_database_client(os.ennviron['COSMOS_DB_NAME'])
...
blob_container_client = blob_service_client.get_container_client(os.envionn['AZURE_STORAGE_CONTAINER_NAME'])
...
def get_movie_summary(movie_id):
    ...
    prompt = f"Create the movie summary '{movie['title']}' released in {movie['year']}."
